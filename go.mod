...
replace (
	github.com/ikawaha/kagome-dict-ipa-neologd/internal/mod0 v0.0.0-00010101000000-000000000000 => ./internal/mod0
	github.com/ikawaha/kagome-dict-ipa-neologd/internal/mod1 v0.0.0-00010101000000-000000000000 => ./internal/mod1
)
